...
local title = ("𝑆𝐸𝑅𝐴𝑃𝐻 𝐻𝑈𝐵 - %s"):format(displayName)
...
local window = library:AddWindow(title, {
    title_bar = {Color3.fromRGB(45, 45, 45), Color3.fromRGB(25, 25, 25), Color3.fromRGB(10, 10, 10)},
    title_bar_transparency = 0.1,
    background = {Color3.fromRGB(18, 18, 18), Color3.fromRGB(10, 10, 10), Color3.fromRGB(5, 5, 5)},
    background_transparency = 0.05,
    main_color = Color3.fromRGB(225, 225, 225),
...
Credits:AddLabel("ECHO POR BL4Z3R LIDER Z3R")
Credits:AddLabel("")
Credits:AddLabel("")
Credits:AddLabel("")
Credits:AddLabel("")
